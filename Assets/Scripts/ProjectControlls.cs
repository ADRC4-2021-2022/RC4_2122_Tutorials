...
//     version 1.1.1
//     from Assets/Scripts/ProjectControlls.inputactions
//
...
public partial class @ProjectControlls : IInputActionCollection2, IDisposable
{
    public InputActionAsset asset { get; }
    public @ProjectControlls()
    {
        asset = InputActionAsset.FromJson(@"{
    ""name"": ""ProjectControlls"",
    ""maps"": [
        {
            ""name"": ""Camera"",
    ...
    {
        private @ProjectControlls m_Wrapper;
        public CameraActions(@ProjectControlls wrapper) { m_Wrapper = wrapper; }
    ...
    {
        private @ProjectControlls m_Wrapper;
        public PlayerActions(@ProjectControlls wrapper) { m_Wrapper = wrapper; }
